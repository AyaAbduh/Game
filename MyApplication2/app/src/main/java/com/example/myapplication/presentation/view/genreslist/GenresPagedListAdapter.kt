...
class GenresPagedListAdapter(public val context: Context) : PagedListAdapter<Genres, RecyclerView.ViewHolder>(
    MovieDiffCallback()
) {
    ...
    class MovieDiffCallback : DiffUtil.ItemCallback<Genres>() {
    ...
    class MovieItemViewHolder (view: View) : RecyclerView.ViewHolder(view) {
        ...
        fun bind(genres: Genres?,context: Context) {
            itemView.cv_movie_title.text = genres?.name
